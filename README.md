...
Fernandez FR, Mehaffey WH, Turner RW (2005) Dendritic Na+ current inactivation can increase cell excitability by delaying a somatic depolarizing afterpotential. *J Neurophysiol* 94:3836-48
...
If you have the signal processing toolbox you can run the MATLAB program `ELLburstpyramidal.m`, otherwise run the MATLAB program `ELLburstpyramidal_noSigProcToolbox.m`.
